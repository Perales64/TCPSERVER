...
void tarea_ia(void *arg)
{
    ...
    printf("Sistema de IA inicializado correctamente\n");
    printf("Escuchando comandos de voz...\n\n");
...
cy_rslt_t init_ml_model(void)
{
    ...
    if (result == CY_RSLT_SUCCESS) {
        ml_initialized = true;
        printf("Modelo ML inicializado correctamente\n");
    } else {
