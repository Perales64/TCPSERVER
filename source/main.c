...
int main(void)
{
    ...
    Buzon_ia_to_tcp = xQueueCreate(20, sizeof(message_t));
    Buzon_tcp_to_control = xQueueCreate(20, sizeof(message_t));
    Buzon_control_to_tcp = xQueueCreate(20, sizeof(message_t));
